...
proc create_root_design { parentCell } {
  ...
  set arduino_ar0_ar13_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 arduino_ar0_ar13_0 ]

  # Create ports
  set BCLK [ create_bd_port -dir O BCLK ]
  set FCLK_CLK1 [ create_bd_port -dir O -type clk FCLK_CLK1 ]
  set LED_0 [ create_bd_port -dir O -from 0 -to 0 -type data LED_0 ]
  set LED_1 [ create_bd_port -dir O -from 0 -to 0 -type data LED_1 ]
  set LED_2 [ create_bd_port -dir O -from 0 -to 0 -type data LED_2 ]
  set LED_3 [ create_bd_port -dir O -from 0 -to 0 -type data LED_3 ]
  ...
  set SW_Enable [ create_bd_port -dir I SW_Enable ]
  set SW_Port [ create_bd_port -dir I -type data SW_Port ]
  set btn1 [ create_bd_port -dir I -type data btn1 ]
  set btn2 [ create_bd_port -dir I -type data btn2 ]

  # Create instance: Speaker_0, and set properties
  set Speaker_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Speaker:1.0 Speaker_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_IS_DUAL {0} \
   CONFIG.GPIO_BOARD_INTERFACE {arduino_ar0_ar13} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $axi_gpio_1

  # Create instance: fir_left1, and set properties
  set fir_left1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fir:1.0 fir_left1 ]

  # Create instance: fir_right, and set properties
  set fir_right [ create_bd_cell -type ip -vlnv xilinx.com:hls:fir:1.0 fir_right ]

  # Create instance: in_out_left, and set properties
  set in_out_left [ create_bd_cell -type ip -vlnv xilinx.com:hls:in_out:1.0 in_out_left ]

  # Create instance: in_out_right, and set properties
  set in_out_right [ create_bd_cell -type ip -vlnv xilinx.com:hls:in_out:1.0 in_out_right ]
  ...
  # Create instance: system_processing_system7_0, and set properties
  set system_processing_system7_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 system_processing_system7_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports arduino_ar0_ar13_0] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins system_processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins system_processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_IIC_1 [get_bd_intf_ports IIC_1] [get_bd_intf_pins system_processing_system7_0/IIC_1]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins ps7_0_axi_periph/S00_AXI] [get_bd_intf_pins system_processing_system7_0/M_AXI_GP0]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins fir_left1/s_axi_fir_io] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins in_out_left/s_axi_fir_io] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins in_out_right/s_axi_fir_io] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]

  # Create port connections
  connect_bd_net -net SDATA_I_1 [get_bd_ports SDATA_I] [get_bd_pins zed_audio_ctrl_0/SDATA_I]
  connect_bd_net -net SW_Enable_1 [get_bd_ports SW_Enable] [get_bd_pins Speaker_0/Enable]
  connect_bd_net -net SW_Port_1 [get_bd_ports SW_Port] [get_bd_pins fir_left1/SW_flag] [get_bd_pins fir_right/SW_flag]
  connect_bd_net -net Speaker_0_PWM [get_bd_ports PWM_OUT] [get_bd_pins Speaker_0/PWM]
  connect_bd_net -net btn1_1 [get_bd_ports btn1] [get_bd_pins in_out_left/s_up] [get_bd_pins in_out_right/s_up]
  connect_bd_net -net btn2_1 [get_bd_ports btn2] [get_bd_pins in_out_left/s_down] [get_bd_pins in_out_right/s_down]
  connect_bd_net -net fir_left1_interrupt [get_bd_pins fir_left1/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net fir_right_LED [get_bd_ports LED_0] [get_bd_pins fir_right/LED]
  connect_bd_net -net fir_right_LED_2 [get_bd_ports LED_1] [get_bd_pins fir_right/LED_2]
  connect_bd_net -net fir_right_LED_3 [get_bd_ports LED_2] [get_bd_pins fir_right/LED_3]
  connect_bd_net -net fir_right_LED_4 [get_bd_ports LED_3] [get_bd_pins fir_right/LED_4]
  connect_bd_net -net fir_right_interrupt [get_bd_pins fir_right/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net in_out_left_interrupt [get_bd_pins in_out_left/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net in_out_right_interrupt [get_bd_pins in_out_right/interrupt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Speaker_0/Clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins fir_left1/ap_clk] [get_bd_pins fir_right/ap_clk] [get_bd_pins in_out_left/ap_clk] [get_bd_pins in_out_right/ap_clk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_processing_system7_0/FCLK_CLK0] [get_bd_pins system_processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins zed_audio_ctrl_0/S_AXI_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1] [get_bd_pins system_processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins system_processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Speaker_0/Rst] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins fir_left1/ap_rst_n] [get_bd_pins fir_right/ap_rst_n] [get_bd_pins in_out_left/ap_rst_n] [get_bd_pins in_out_right/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins system_processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces system_processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces system_processing_system7_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces system_processing_system7_0/Data] [get_bd_addr_segs fir_left1/s_axi_fir_io/Reg] SEG_fir_left1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces system_processing_system7_0/Data] [get_bd_addr_segs fir_right/s_axi_fir_io/Reg] SEG_fir_right_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces system_processing_system7_0/Data] [get_bd_addr_segs in_out_left/s_axi_fir_io/Reg] SEG_in_out_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces system_processing_system7_0/Data] [get_bd_addr_segs in_out_right/s_axi_fir_io/Reg] SEG_in_out_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces system_processing_system7_0/Data] [get_bd_addr_segs zed_audio_ctrl_0/S_AXI/reg0] SEG_zed_audio_ctrl_0_reg0
