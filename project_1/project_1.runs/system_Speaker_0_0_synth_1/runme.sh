...
HD_PWD='C:/Users/ZYY/Documents/Vivado/project_1/project_1.runs/system_Speaker_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Speaker_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Speaker_0_0.tcl
