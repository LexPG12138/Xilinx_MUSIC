...
HD_PWD='C:/Users/ZYY/Documents/Vivado/Audio/audio/audio.runs/system_fir_left1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fir_left1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fir_left1_0.tcl
