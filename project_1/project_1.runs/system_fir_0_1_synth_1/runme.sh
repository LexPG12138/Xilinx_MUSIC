...
HD_PWD='C:/Users/ZYY/Documents/Vivado/Audio/audio/audio.runs/system_fir_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fir_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fir_0_1.tcl
